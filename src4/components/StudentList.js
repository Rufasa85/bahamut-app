...
export default function StudentList() {
  //  Import the students, actions and majors from our custom useStudentContext hook
  const {students,majors,addStudent,removeStudent} = useStudentContext()
          ...
          <section className="student-list">
                  ...
                  <tr key={student.id}>
                    ...
                    <td>
                      <button
                        type="button"
                        onClick={() => {
                          // Update the button's onClick so that it will remove students
                          // Your code here
            ...
            <div className="add-student">
              ...
              >
                ...
                {/* // Map over each major and return an <option> element for each with all the necessary attributes*/}
                {majors.map((maj,i)=><option key={i}>{maj}</option>)}
                {/* Your code here */}
              </select>
              <button
                type="button"
